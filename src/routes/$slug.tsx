    ...
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:py-10">
        ...
        <Card className="overflow-hidden border-border/70 bg-card shadow-card">
          <div className="border-b bg-muted/30 px-5 py-8 sm:px-10 sm:py-10"><div className="flex items-center justify-between gap-4"><div><p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Member profile</p><p className="mt-2 text-sm text-muted-foreground">NJBS ICT Club · Public directory</p></div><Badge variant="outline" className="rounded-full bg-card px-3 py-1">Verified profile</Badge></div></div>
