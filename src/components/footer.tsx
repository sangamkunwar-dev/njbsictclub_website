...
const SOCIAL_LINKS = [
  ...
  { label: "Instagram", href: "https://instagram.com/njbsictclub", Icon: Instagram },
  {
    label: "Facebook",
    href: "https://facebook.com/people/ICT-club-of-NJBS/61579757489748",
    Icon: Facebook,
  },
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-muted-foreground max-w-md">
            A community of students, developers, designers, and researchers at Nawa Jyoti English
            Boarding School building meaningful technology.
          </p>
